              ...
              <div className="modal">
                ...
                <div><Techno technologies={technologies}/></div>
                  <div className="link-projects">
                    { trad ? (
                      <>
                        <a href={`${site}`} target="_blank"><button className="button-black"><i className="fa-brands fa-safari"></i> Project</button></a>
                        <a href={`${github}`} target="_blank"><button className="button-black"><i className="fa-solid fa-code"></i> Code</button></a>
                      </>
                    ) : (
                      <>
                        <a href={`${site}`} target="_blank"><button className="button-black"><i className="fa-brands fa-safari"></i> Projet</button></a>
                        <a href={`${github}`} target="_blank"><button className="button-black"><i className="fa-solid fa-code"></i> Code</button></a>
                      </>
                    )}
                  </div>
